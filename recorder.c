...
static void feedback_suppress_en(void){
     // 切换啸叫抑制开关            
        ...
        /*
        printf("Feedback suppression %s\n", 
              __this->feedback_suppress_en ? "ENABLED" : "DISABLED");
              */
    #endif
